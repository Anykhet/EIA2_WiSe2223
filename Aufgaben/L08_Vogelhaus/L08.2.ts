...
function drawSnowman(): void {
    ...
    crc2.beginPath();
    crc2.arc(positionX +7, positionY -307, radius - 66, 0,  2 * Math.PI);
    crc2.fillStyle = "black";
    crc2.fill();
    crc2.closePath();
...
//Funktion für Schneeflocken 
 function drawsnowflakes(): void {
    ...
    for (let index: number = 0; index < 600; index++) {                     // For-Schleife 
...
function drawhouse(_position: Vector): void {
    ...
    crc2.save();
    crc2.beginPath();
    crc2.translate(_position.x, _position.y -30);
    crc2.moveTo(-80, 0);
    crc2.lineTo(80, 0);
    crc2.lineTo(80, -120);
    crc2.lineTo(120, -120);
 ...
 //Loch des Vogelhauses
    ...
    crc2.save();
    crc2.beginPath();
    crc2.translate(_position.x, _position.y - 15);
    crc2.fillStyle = "white";
    crc2.arc(0, -60, hole, 0, 2 * Math.PI);
    crc2.fill();
    crc2.closePath();
    crc2.restore();
 ...
 //Funktion für Vögel auf dem Boden
  function drawbird(_position:Vector): void{
    for (let index: number = 0; index < 9; index++) {
        ...
        let maxWidth: number = 800;                     //bestimmt maximale Weite
        let minWidth: number = 100;                     //bestimmt minimale Weite
        let minHeight: number = 515;                    //bestimmt minimale Höhe
        let maxHeight: number = 530;                    //bestimmt maximale Höhe
