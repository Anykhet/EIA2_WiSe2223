/*
 ...
 Matrikel: <2711441>
 Datum: <02.12.2022>
 Quellen: <Pia Giovannelli, Arthur Aguair, Lisa Blindenhöfer>
*/
var Vogelhaus;
(function (Vogelhaus) {
    ...
    function drawBackground(_horizon) {
        ...
        gradientMeadow.addColorStop(0, "grey");
    ...
    function drawSnowman() {
        ...
        //Nase Linie
        Vogelhaus.crc2.beginPath();
        Vogelhaus.crc2.moveTo(310, 310);
        Vogelhaus.crc2.lineTo(300, 300);
        Vogelhaus.crc2.stroke();
        Vogelhaus.crc2.closePath();
        //Augen
        Vogelhaus.crc2.beginPath();
        ...
        Vogelhaus.crc2.closePath();
        Vogelhaus.crc2.beginPath();
        Vogelhaus.crc2.arc(positionX + 7, positionY - 307, radius - 66, 0, 2 * Math.PI);
        Vogelhaus.crc2.fillStyle = "black";
        Vogelhaus.crc2.fill();
        Vogelhaus.crc2.closePath();
        //Mund
        ...
        //Knöpfe
        Vogelhaus.crc2.beginPath();
        Vogelhaus.crc2.arc(positionX + 4, positionY - 200, radius - 65, 0, 2 * Math.PI);
        Vogelhaus.crc2.fillStyle = "black";
        Vogelhaus.crc2.fill();
        Vogelhaus.crc2.closePath();
        Vogelhaus.crc2.beginPath();
        Vogelhaus.crc2.arc(positionX + 4, positionY - 220, radius - 65, 0, 2 * Math.PI);
        Vogelhaus.crc2.fillStyle = "black";
        Vogelhaus.crc2.fill();
        Vogelhaus.crc2.closePath();
    }
    ...
    function drawsnowflakes() {
        ...
        for (let index = 0; index < 600; index++) { // For-Schleife 
    ...
    //Funktion für Vogelhaus
    function drawhouse(_position) {
        console.log("Vogelhaus");
        //Oberer Teil des Hauses
        Vogelhaus.crc2.save();
        Vogelhaus.crc2.beginPath();
        Vogelhaus.crc2.translate(_position.x, _position.y - 30);
        ...
        Vogelhaus.crc2.closePath();
        Vogelhaus.crc2.restore();
        //Loch des Vogelhauses
        let hole = 32;
        Vogelhaus.crc2.save();
        Vogelhaus.crc2.beginPath();
        Vogelhaus.crc2.translate(_position.x, _position.y - 15);
        Vogelhaus.crc2.fillStyle = "white";
        Vogelhaus.crc2.arc(0, -60, hole, 0, 2 * Math.PI);
        Vogelhaus.crc2.fill();
        Vogelhaus.crc2.closePath();
        Vogelhaus.crc2.restore();
    }
    //Vögel zeichnen 
    //Funktion für die fliegenden Vögel
    ...
    function drawbird(_position) {
        for (let index = 0; index < 9; index++) {
            let maxWidth = 800; //bestimmt maximale Weite
            let minWidth = 100; //bestimmt minimale Weite
            let minHeight = 515; //bestimmt minimale Höhe
            let maxHeight = 530; //bestimmt maximale Höhe
    ...
    //Funktion für den sitzenden Vogel 
