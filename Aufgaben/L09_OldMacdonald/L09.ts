...
namespace Farm {
    ...
    function loadAnimals(): void {
        let cow: Animal = new Animal("Buttermilch", "cow", "greens", "moo", 10); //Kuh
        let dog: Animal = new Animal("Mila", "dog", "meat", "woof", 12); //Hund
        let cat: Animal = new Animal("Malya", "cat", "fish", "miauz", 5); //Katze
        let chicken: Animal = new Animal("Kevin", "chicken", "corn", "bock", 30); //Huhn
        let pig: Animal = new Animal("Peppa", "pig", "carrots", "quick", 25); //Schwein
